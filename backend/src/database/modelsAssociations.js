module.exports = db => {
  ...
  Ean.hasMany(EanInAfnRemovalOrder, {
    foreignKey: 'ean',
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  });
  ...
  Sku.hasMany(AfnRemovalShipmentsDetails, {
    foreignKey: 'skuId',
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  });
  Sku.hasMany(AfnRemovalOrdersDetails, {
    foreignKey: 'skuId',
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  });
  ...
  AfnRemovalOrders.hasMany(EanInAfnRemovalOrder, {
    foreignKey: 'afnRemovalOrderId',
    onDelete: 'NO ACTION',
    onUpdate: 'CASCADE',
  });
