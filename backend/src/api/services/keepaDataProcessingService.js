        ...
        (async () => {
          try {
            ...
            const mappedData = {
              ...
              productCategoryId,
              reviewsRating: parseAndValidateNumber(
                data['Revues: Évaluation'],
                {
                  min: 0,
                  max: 5,
                  decimals: 2,
              ...
              fbaPickPackFee: parseAndValidateNumber(
                data['FBA Pick&Pack Fee'],
                {
                  min: 0,
                  decimals: 2,
              ...
              buyBoxCurrent: parseAndValidateNumber(
                data['Buy Box 🚚: Courant'],
                {
                  min: 0,
                  decimals: 2,
              ...
              buyBoxHighest: parseAndValidateNumber(
                data['Buy Box 🚚: Highest'],
                {
                  min: 0,
                  decimals: 2,
